...
Update 24 September 2026: Published privacy, terms and support under https://lrodeveloperr.github.io/privacy-policy/powder-run/ and wired the app and listing. The prior validation scores are historical; rerun after this change. Apple sign-in did not complete, so App Store Connect fields, products and TestFlight remain unverified.
